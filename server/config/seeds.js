  ...
  const movies = await db.movies.insertMany([
    // Season 1
    {
     ...
     }, 
     {
      ...
      tags: [ 'classic' , 'must-see' , 'black and white' , 'iconic' , 'adventure' , 'human rights' , 'politics' , 'powerful' ], 
      viewingNumber: 21,
     ...
     }, 
     {
      ...
      tags: [ 'classic' , 'must-see' , 'touching' , 'sweet' , 'travel' , 'iconic' , 'laugh out loud' , 'tearjerker' , 'fairy-tale' , 'magic' , 'perfection' , 'italy' ],
      viewingNumber: 22,
     ...
     }, 
     {
      ...
      tags: [ 'buddy comedy' , 'screwball comedy' , 'quirky' , 'cult classic' , 'iconic' , 'gay cinema' , 'fun' , 'funny' , 'silly' ], 
      viewingNumber: 28,
